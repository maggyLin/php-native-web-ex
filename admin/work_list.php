...
<body style="padding-top: 50px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <a href="work_add.php" class="btn btn-warning" role="button">新增作品</a>
            </div>
        </div>
        <br>
        <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <?php if(!empty($datas)): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $data["video_path"] ;?></td>
                            <td><?php echo ($data["publish"]==1)?"發佈":"未發佈"; ?></td>
                            <td><a class='btn btn-success' href='work_edit.php?i=<?php echo $data["id"];?>' role='button'>編輯</a>
